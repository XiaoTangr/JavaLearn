...
public class DataBackupService {
    ...
    private static volatile DataBackupService instance;

    private DataBackupService() {
    }

    public static DataBackupService getInstance() {
        if (instance == null) {
            synchronized (DataBackupService.class) {
                if (instance == null) {
                    instance = new DataBackupService();
                }
            }
        }
        return instance;
